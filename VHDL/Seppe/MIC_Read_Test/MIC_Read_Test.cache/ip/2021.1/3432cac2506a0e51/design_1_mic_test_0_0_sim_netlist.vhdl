...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mic_test is
  signal PDMclk_counter : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \PDMclk_counter[3]_i_2_n_0\ : STD_LOGIC;
  signal \PDMclk_counter[6]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \PDMclk_counter[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \PDMclk_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \PDMclk_counter[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \PDMclk_counter[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \PDMclk_counter[6]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \PDMclk_counter[7]_i_1\ : label is "soft_lutpair3";
...
\PDMclk_counter[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\PDMclk_counter[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFC011C0"
    )
        port map (
...
\PDMclk_counter[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \PDMclk_counter_reg_n_0_[6]\,
      I4 => \PDMclk_counter_reg_n_0_[1]\,
      I5 => \PDMclk_counter_reg_n_0_[0]\,
...
\PDMclk_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \PDMclk_counter[6]_i_2_n_0\,
      I4 => \PDMclk_counter_reg_n_0_[4]\,
      I5 => \PDMclk_counter_reg_n_0_[6]\,
      O => PDMclk_counter(6)
    );
\PDMclk_counter[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => \PDMclk_counter_reg_n_0_[0]\,
      I1 => \PDMclk_counter_reg_n_0_[1]\,
      O => \PDMclk_counter[6]_i_2_n_0\
    );
\PDMclk_counter[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
\PDMclk_counter[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
