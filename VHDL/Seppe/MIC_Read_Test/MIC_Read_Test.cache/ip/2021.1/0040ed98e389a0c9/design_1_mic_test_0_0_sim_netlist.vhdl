...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mic_test is
  ...
  attribute SOFT_HLUTNM of \PDMclk_counter[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \PDMclk_counter[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \PDMclk_counter[7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of PDMclk_i_2 : label is "soft_lutpair0";
begin
  o_mic_clk <= \^o_mic_clk\;
...
\PDMclk_counter[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\PDMclk_counter[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00FFDFFFFF000000"
    )
        port map (
...
\PDMclk_counter[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7F803F807F807F80"
    )
        port map (
...
\PDMclk_counter[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\PDMclk_counter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
