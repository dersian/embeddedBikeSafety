...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mic_test is
  ...
  attribute SOFT_HLUTNM of \PDMclk_counter[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \PDMclk_counter[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \PDMclk_counter[2]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \PDMclk_counter[6]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \PDMclk_counter[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of PDMclk_i_2 : label is "soft_lutpair2";
begin
  o_mic_clk <= \^o_mic_clk\;
\PDMclk_counter[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
